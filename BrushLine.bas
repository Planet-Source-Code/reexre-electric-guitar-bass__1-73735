...
Attribute FastLine.VB_Description = "disegna line veloce"
    ...
    If OldColor <> color Then DeleteObject (SelectObject(Hdc, CreatePen(vbSolid, w, color))): OldColor = color
...
Sub MyCircle(ByRef Hdc As Long, ByRef X As Long, ByRef Y As Long, ByRef R As Long, w, color)
    ...
    If OldColor <> color Then
        ...
        DeleteObject (SelectObject(Hdc, CreatePen(vbSolid, w, color))): OldColor = color
    End If
...
Public Sub bLOCK(ByRef Hdc As Long, X As Long, Y As Long, w As Long, color As Long)
    ...
    If OldColor <> color Then DeleteObject (SelectObject(Hdc, CreatePen(vbSolid, 1, color))): OldColor = color
